...
public class GreaterEqual extends Function
{
	...
	if(left == null || right == null) {
	    System.out.println("Error: Greaterequal recieved null argument");
	    System.exit(1);
	}
	if(left.type != NType.NUM) {
	    System.out.println("Error: greaterequal takes only a num, " + left.type + " given");
	    System.exit(1);
	}
	if(right.type != NType.NUM) {
	    System.out.println("Error: greaterequal takes only a num, " + right.type + " given");
	    System.exit(1);
	}
